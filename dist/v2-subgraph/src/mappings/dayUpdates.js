...
import { Bundle, Pair, PairDayData, TokenDayData, UniswapDayData, UniswapFactory } from '../types/schema';
...
export function updatePairDayData(event) {
    let timestamp = event.block.timestamp.toI32();
    let dayID = timestamp / 86400;
    let dayStartTimestamp = dayID * 86400;
...
export function updatePairHourData(event) {
    let timestamp = event.block.timestamp.toI32();
...
export function updateTokenDayData(token, event) {
...
//# sourceMappingURL=dayUpdates.js.map